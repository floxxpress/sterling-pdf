...
;              
CREATE USER IF NOT EXISTS "SA" SALT 'd4bd9aee3aeca7ab' HASH 'ac412d0870be8f0770450af020f3645383733a133de07aafd95543f3da16a4f7' ADMIN;          
...
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME") VALUES(1, NULL, 'web', TRUE, TRUE, '$2a$10$QWY1iK/p4tQh039aY3951Ov.pNuCzyzE9UGncM8Hs3fb0Zjc18OtW', NULL, 'admin');  
INSERT INTO "PUBLIC"."USERS"("USER_ID", "API_KEY", "AUTHENTICATIONTYPE", "ENABLED", "IS_FIRST_LOGIN", "PASSWORD", "ROLE_NAME", "USERNAME") VALUES(2, '5f23efe1-e47b-4f72-a188-13fe52530c74', 'web', TRUE, FALSE, '$2a$10$hfMG5kEBNAlkyqPDPNu0kuSbAUFis.tUkSdKx2mL.VcCVh3dL3yoK', NULL, 'STIRLING-PDF-BACKEND-API-USER');       
